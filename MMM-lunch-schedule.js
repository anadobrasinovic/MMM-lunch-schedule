...
Module.register("MMM-lunch-schedule", {
  ...
  getWeekDay: function (timestamp) {
	var self = this;
	self.config.WEEK_DAYS[new Date(timestamp).getDay()]
  },
